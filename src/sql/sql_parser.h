...
public:
    ...
    virtual antlrcpp::Any visitArthmeticBinary(
        SqlGrammarParser::ArthmeticBinaryContext *ctx) override {
        Expr::ptr leftExpr = visit(ctx->left).as<Expr::ptr>();
        Expr::ptr rightExpr = visit(ctx->right).as<Expr::ptr>();
    ...
    virtual antlrcpp::Any visitComparisonBinary(
        SqlGrammarParser::ComparisonBinaryContext *ctx) override {
        Expr::ptr leftExpr = visit(ctx->left).as<Expr::ptr>();
        Expr::ptr rightExpr = visit(ctx->right).as<Expr::ptr>();
    ...
    virtual antlrcpp::Any visitParenthesizedExpression(
        SqlGrammarParser::ParenthesizedExpressionContext *ctx) override {
        Expr::ptr expr = visit(ctx->expression()).as<Expr::ptr>();
    ...
    virtual antlrcpp::Any visitNullLiteral(
        SqlGrammarParser::NullLiteralContext *ctx) override {
        return (Expr::ptr)std::make_shared<NullLiteral>();
    }

    virtual antlrcpp::Any visitStringLiteral(
        SqlGrammarParser::StringLiteralContext *ctx) override {
        return (Expr::ptr)std::make_shared<StringLiteral>(
            ctx->STRING_LITERAL()->getText());
    }

    virtual antlrcpp::Any visitIntegerLiteral(
        SqlGrammarParser::IntegerLiteralContext *ctx) override {
        return (Expr::ptr)std::make_shared<IntegerLiteral>(
            stol(ctx->INTEGER_LITERAL()->getText()));
    }

    virtual antlrcpp::Any visitDecimalLiteral(
        SqlGrammarParser::DecimalLiteralContext *ctx) override {
        return (Expr::ptr)std::make_shared<DecimalLiteral>(
            stod(ctx->DECIMAL_LITERAL()->getText()));
    }

    virtual antlrcpp::Any visitBooleanValue(
        SqlGrammarParser::BooleanValueContext *ctx) override {
        if (ctx->TRUE() != nullptr) {
    ...
    virtual antlrcpp::Any visitColumnIdentifier(
        SqlGrammarParser::ColumnIdentifierContext *ctx) override {
    ...
    virtual antlrcpp::Any visitIdentifier(
        SqlGrammarParser::IdentifierContext *ctx) override {
        if (ctx->IDENTIFIER() != nullptr) {
