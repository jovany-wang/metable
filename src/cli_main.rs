use metaservice::{client, DEFAULT_PORT};
...
#[structopt(name = "metacli", version = env!("CARGO_PKG_VERSION"), author = env!("CARGO_PKG_AUTHORS"), about = "Issue Redis commands")]
struct Cli {
...
async fn main() -> metaservice::Result<()> {
    // Enable logging
